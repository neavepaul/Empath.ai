!(function (t, e) {
		...
		t in i ||
			(i[t] = (function (e) {
				...
				return (
					...
					1 === e
						? t.getContext("webgl", u) ||
						  t.getContext("experimental-webgl", u)
		...
		return (
					...
					return R(this, function (t) {
						switch (t.label) {
							...
							case 1:
								return (
									(e = t.sent()),
									[2, pt.buffer(this.shape, this.dtype, e)]
								);
						}
					});
				});
			...
			(o.prototype.data = function () {
				return m(this, void 0, void 0, function () {
					return R(this, function (t) {
						return (
							this.throwIfDisposed(), [2, ht().read(this.dataId)]
						);
					});
				});
			}),
			...
			(o.prototype.squaredDifferenceStrict = function (t) {
				return (
					this.throwIfDisposed(), pt.squaredDifferenceStrict(this, t)
				);
			}),
			...
			(o.prototype.unsortedSegmentSum = function (t, e) {
				return (
					this.throwIfDisposed(), pt.unsortedSegmentSum(this, t, e)
				);
			}),
			...
			(function t(e, n, r) {
				if (null != e)
					if (e instanceof dt) n.push(e);
						...
						((s = e), Array.isArray(s) || "object" == typeof s)
					) {
						var o = e;
						for (var i in o) {
							var a = o[i];
						...
						return R(this, function (t) {
							return (
								...
								(this.activeProfile.peakBytes = Math.max.apply(
									Math,
									this.activeProfile.kernels.map(function (
										t
									) {
										return t.totalBytesSnapshot;
									})
								)),
								(this.activeProfile.newBytes =
									this.numBytes - e),
								(this.activeProfile.newTensors =
									this.numTensors - n),
			...
			n =
				...
				t.replace(/[?&]([^=?&]+)(?:=([^&]*))?/g, function (t) {
					...
					return (
						...
						(o = e[0]),
						(i = e[1]),
						(r[decodeURIComponent(o)] = decodeURIComponent(
							i || ""
						)),
						e.join("=")
					);
			...
			return (
				...
				(t.prototype.evaluateFeature = function (t) {
					...
					if ("WEBGL_RENDER_FLOAT32_ENABLED" === t)
						return (function (t) {
							...
							} else if (!Vt(e, "EXT_color_buffer_float"))
								return !1;
							return Ht(e, t);
						})(this.get("WEBGL_VERSION"));
					if ("WEBGL_DOWNLOAD_FLOAT_ENABLED" === t)
						return (function (t) {
							...
							if (1 === t) {
								if (!Vt(e, "OES_texture_float")) return !1;
								if (!Vt(e, "WEBGL_color_buffer_float"))
									return !1;
							} else if (!Vt(e, "EXT_color_buffer_float"))
								return !1;
							return Ht(e, t);
				...
				(t.prototype.registerBackend = function (t, e, n) {
					...
					try {
						...
						return (
							console.warn(
								"Registration of backend " + t + " failed"
							),
	...
	function Ie(t, e, n) {
		...
		!(function (t, e, n) {
			...
			if (t.length < r + (n.rank - o))
				throw new Error(
					i + " Output shape length < " + (r + (n.rank - o))
				);
	...
	function Fe(t) {
		...
		return (
			Object.defineProperty(n, "name", { value: r, configurable: !0 }), n
		);
	}
	var Le = Fe({
	...
	var en = Fe({
		...
		on = (function () {
			...
			return (
				...
				(t.prototype.stridedSlice = function (
					t,
					e,
					n,
					r,
				...
				(t.prototype.resizeNearestNeighborBackprop = function (
					t,
					e,
					n
				) {
	...
	function an(t, e, n) {
		...
		if ("bool" !== e)
			throw new Error(
				"Error in Cast: unknown dtype argument (" + e + ")"
			);
		var s = Ve(0, t.dtype);
		...
		gr = (function () {
			...
			return (
				(t.prototype.getCustomSetupFunc = function (n) {
					...
					return function (t, e) {
						null == r.valueLoc &&
							(r.valueLoc = t.getUniformLocationNoThrow(
								e,
								"value"
							)),
		...
		xr = function (t, e, n) {
			...
			var o = Dn(this.rank),
				i = (function (t, e) {
					...
					if (4 < n)
						throw Error(
							"Gather for rank " + n + " is not yet supported"
						);
		...
		return (
			e &&
				(function (t) {
					var e = t.getError();
					if (e !== t.NO_ERROR)
						throw new Error("WebGL Error: " + Mr(t, e));
				})(t),
			r
		);
	}
	((Cr = wr || (wr = {}))[(Cr.RENDER = 0)] = "RENDER"),
		...
		((Er = br || (br = {}))[(Er.UNPACKED_FLOAT16 = 0)] =
			"UNPACKED_FLOAT16"),
			...
			throw (
				((function (t, e) {
					...
					if (null == n)
						return (
							console.log(
								"Couldn't parse line number in error: " + e
							),
							console.log(t)
						);
					for (
	...
	var Do = Object.freeze({
		...
		Mo = (function () {
			...
			return (
				...
				(t.prototype.createUnsignedBytesMatrixTexture = function (
					t,
					e
				) {
					return (
				...
				(t.prototype.createFloat16PackedMatrixTexture = function (
					t,
					e
				) {
					return (
				...
				(t.prototype.downloadFloat32MatrixFromBuffer = function (
					t,
					e,
					n
				) {
					...
					if (Zt.get("WEBGL_FENCE_API_ENABLED")) {
						...
						t.flush(),
							(n = function () {
								...
								return (
									t === o.ALREADY_SIGNALED ||
									t === o.CONDITION_SATISFIED
								);
							}),
							(e = i);
					} else
				...
				(t.prototype.getUniformLocationNoThrow = function (t, e) {
					return (
						this.throwIfDisposed(), this.gl.getUniformLocation(t, e)
					);
				}),
				...
				(t.prototype.setOutputMatrixWriteRegion = function (
					t,
					e,
					n,
					r
				...
				(t.prototype.addItemToPoll = function (t, e) {
					...
					this.itemsToPoll.push({ isDoneFn: t, resolveFn: e }),
						1 < this.itemsToPoll.length ||
							S(function () {
								return (
									n.pollItems(), 0 === n.itemsToPoll.length
								);
							});
				}),
		...
		zo = (function () {
			...
			return (
				(t.prototype.getCustomSetupFunc = function (n) {
					...
					return function (t, e) {
						null == r.seedLoc &&
							(r.seedLoc = t.getUniformLocation(e, "seed")),
			...
			this.userCode =
				1 === t
					...
					: "\n        void main() {\n          " +
					  ...
					  s +
					  "){\n            result.g = " +
					  (((r = o.slice())[t - 1] = "(" + r[t - 1] + " + 1)"),
					  l(r)) +
					  ";\n          }\n          if(" +
					  u +
					  ") {\n            result.b = " +
					  (((n = o.slice())[t - 2] = "(" + n[t - 2] + " + 1)"),
					  l(n)) +
					  ";\n            if(" +
					  s +
					  ") {\n              result.a = " +
		...
		oi = (function () {
			...
			return (
				(t.prototype.getCustomSetupFunc = function (n) {
					...
					return function (t, e) {
						(null == r.startLoc &&
							((r.startLoc = t.getUniformLocationNoThrow(
								e,
								"start"
							)),
							null == r.startLoc)) ||
				...
				(t.prototype.acquireTexture = function (t, e, n) {
					...
					return (
						...
						o === br.PACKED_2X2_FLOAT32
							? (r = this.gpgpu.createPackedMatrixTexture(
									t[0],
									t[1]
							  ))
							...
							? (r = this.gpgpu.createFloat32MatrixTexture(
									t[0],
									t[1]
							  ))
	...
	function ci(t, e) {
		if (t === wr.UPLOAD)
			return e ? br.PACKED_2X2_FLOAT32 : br.UNPACKED_FLOAT32;
	...
	var Ai = Ti(function (t) {
				...
				function r(t, e) {
							...
							var r,
								...
								n =
									...
									function (t) {
										...
										return (
											2.3283064365386963e-10 * (r >>> 0)
										);
									});
							(e.next = function () {
								var t =
									2091639 * e.s0 +
									2.3283064365386963e-10 * e.c;
								return (
									(e.s0 = e.s1),
									(e.s1 = e.s2),
									(e.s2 = t - (e.c = 0 | t))
					...
					return (
						...
						(o.double = function () {
							return (
								o() +
								11102230246251565e-32 * ((2097152 * o()) | 0)
							);
						}),
						(o.quick = o),
						r &&
		...
		Fi = Ti(function (t) {
			!(function (t, e, n) {
				function i(t, e) {
					return (
						(e.a = t.a), (e.b = t.b), (e.c = t.c), (e.d = t.d), e
					);
				}
				function r(t, e) {
					var n = new (function (t) {
	...
	var Gi = Fe({
		...
		Ki = Fe({
			eye_: function (t, e, n, r) {
				...
				if (2 === n.length)
					return ca($i($i(s, 0), 0), [n[0], n[1], 1, 1]);
				if (3 === n.length)
	...
	var va = (function () {
		function t(t) {
			...
			if (null == t) {
				...
				(this.binaryCache =
					((n = Zt.get("WEBGL_VERSION")) in da || (da[n] = {}),
					da[n])),
					(this.gpgpu = new Mo(e)),
		...
		return (
					...
					return R(this, function (t) {
						switch (t.label) {
							case 0:
								...
								if (null != a)
									return [2, this.convertAndCacheOnCPU(S)];
								if (
								...
								return (
									...
									u &&
										...
										(m = e[1])),
									(g =
										this.gpgpu.maybeCreateBufferFromTexture(
											i,
											m,
											v
										)),
			...
			(t.prototype.shouldExecuteOnCPU = function (t, e) {
				...
				return (
					...
					null != this.getCPUBackend() &&
						t.every(function (t) {
							return (
								null == n.texData.get(t.dataId).texture &&
								t.size < e
							);
						})
				);
			...
			(t.prototype.slice = function (t, e, n) {
				...
				if (!r && o)
					return (
						this.uploadToGPU(t.dataId), this.shallowSlice(t, e, n)
					);
				var i = Zt.get("WEBGL_PACK_ARRAY_OPERATIONS")
						? new ai(n)
						: new oi(n),
			...
			(t.prototype.conv2dWithIm2Row = function (t, e, n) {
				...
				return this.compileAndRun(v, [d, p]).reshape([
					1,
					s,
					a,
					n.outChannels,
			...
			(t.prototype.compileAndRun = function (o, t, e, n, r) {
				...
				if (
					...
					return (
						(this.texData.get(e.dataId).values = A(e.dtype, 0)), e
					);
				...
				var s,
					...
					l = this.getAndSaveBinary(c, function () {
						return (function (t, r, e, n) {
							var o = r.userCode,
								i = e.map(function (t, e) {
									var n = {
										...
										texShape: t.isUniform
											? null
											: t.texData.texShape,
										isUniform: t.isUniform,
										isPacked:
											!t.isUniform && t.texData.isPacked,
										flatOffset: null,
									};
									return (
										null != t.texData &&
							...
							for (
								var p = {}, f = 0;
								f < r.variableNames.length;
								f++
							) {
								var d = r.variableNames[f];
								(p[d] = t.getUniformLocation(c, d, !1)),
									(p["offset" + d] = t.getUniformLocation(
										c,
										"offset" + d,
										!1
									));
			...
			(t.prototype.uploadToGPU = function (t) {
				...
				if (null == a) {
					...
					Zt.get("WEBGL_NUM_MB_BEFORE_PAGING") <
						Number.POSITIVE_INFINITY &&
					...
					function (t, e) {
						...
						return {
							$x: function () {
								return t
									.divStrict(
										Ve(1).sub(n.toFloat().square()).sqrt()
									)
									.neg();
							},
						};
				...
				return Zt.engine.runKernel(
					...
					function (t, e) {
						...
						return {
							$x: function () {
								return t.divStrict(
									Ve(1).add(n.toFloat().square()).sqrt()
								);
							},
						};
					}
				...
				.runKernel(
					...
					function (n, t) {
						var e = t[0],
							...
							u = [];
						if (1 === r.rank) {
							for (var c = 0; c < v.shape.length - 1; ++c)
								u.push(v.shape[c]);
							u.push(1);
						}
						var l = e.sub(r),
								...
								x: function () {
									return (function (t, e, n, r) {
										...
										var a = Zt.engine.runKernel(
											function (t) {
												return t.depthwiseConv2DDerInput(
													o,
													n,
													r
												);
								...
								$filter: function () {
									return (function (t, e, n, r) {
										...
										return (
											...
											Zt.engine.runKernel(
												function (t) {
													return t.depthwiseConv2DDerFilter(
														o,
														i,
														r
													);
					...
					return {
						x: function () {
							return (function (t, e, n, r, o, i) {
								...
								return l
									? p.as3D(p.shape[1], p.shape[2], p.shape[3])
									: p;
							})(t, s, e, n, r, o);
						},
					};
	...
	var Ys = Fe({
		...
		Js = Fe({
			argMax_: function (t, e) {
				...
				return (
					null != n &&
						((r = r.transpose(n)), (o = Se(o.length, r.rank))),
					Zt.engine.runKernel(
						function (t, e) {
		...
		nu = Fe({
			mean_: function (t, e, r) {
				...
				return ae(function (n) {
					var t = Ve(i);
					return {
						value: (t.dtype === n.dtype ? n : n.cast(t.dtype))
							.div(t)
							.sum(e, r),
						gradFunc: function (t) {
							var e = n.shape.slice();
			...
			sum_: function (t, e, a) {
				...
				return ae(function (n) {
					var t = Ce(s, n.rank),
						...
						r = n;
					null != t &&
						((r = n.transpose(t)), (e = Se(e.length, n.rank)));
	...
	var su = Fe({
		...
		uu = Fe({
			equalStrict_: function (t, e) {
				...
				return (
					g(n.shape, r.shape, "Error in equalStrict: "), n.equal(r)
				);
			},
		}),
		cu = Fe({
		...
		pu = Fe({
			greaterStrict_: function (t, e) {
				...
				return (
					g(n.shape, r.shape, "Error in greaterStrict: "),
					n.greater(r)
				);
			},
		}),
		...
		vu = Fe({
			lessEqualStrict_: function (t, e) {
				...
				return (
					g(n.shape, r.shape, "Error in lessEqualStrict: "),
					n.lessEqual(r)
				);
			},
		}),
		...
		yu = Fe({
			notEqualStrict_: function (t, e) {
				...
				return (
					g(n.shape, r.shape, "Error in notEqualStrict: "),
					n.notEqual(r)
				);
			},
		});
	var xu = Fe({
		...
		Nu = Fe({
			maximumStrict_: function (t, e) {
				...
				return (
					g(n.shape, r.shape, "Error in maximumStrict: "),
					n.maximum(r)
				);
			},
		}),
		...
		Iu = Fe({
			minimumStrict_: function (t, e) {
				...
				return (
					g(n.shape, r.shape, "Error in minimumStrict: "),
					n.minimum(r)
				);
			},
		}),
		...
		Mu = Fe({
			mulStrict_: function (t, e) {
				var n = re(t, "a", "mul"),
					r = re(e, "b", "mul");
				return (
					g(n.shape, r.shape, "Error in multiplyStrict: "), n.mul(r)
				);
			},
		}),
		Ou = Fe({
		...
		norm_: function (t, e, n, r) {
			...
			var o = (function t(e, n, r) {
					...
					if (
						...
						throw new Error(
							"Error in norm: invalid ord value: " + n
						);
					}
							...
							n([t, o]),
							{
								...
								gradFunc: function (t, e) {
									...
									return [
										t
											.reshape(o)
											.mul(n.toFloat().sub(r.exp())),
										t
											.reshape(o)
											.mul(r.exp().sub(n.toFloat())),
									];
								},
							}
						);
	...
	var Oc = Fe({
			resizeBilinear_: function (t, e, r) {
				...
				3 === n.rank &&
					((i = !0),
					(o = n.as4D(1, n.shape[0], n.shape[1], n.shape[2])));
				var a = e[0],
					s = e[1],
					u = Zt.engine.runKernel(
						function (t, e) {
						...
						function (e, n) {
							return {
								batchImages: function () {
									return Zt.engine.runKernel(function (t) {
										return t.resizeBilinearBackprop(
											e,
											n[0],
											r
										);
					...
					u = Zt.engine.runKernel(
						...
						function (e, n) {
							return {
								batchImages: function () {
									return Zt.engine.runKernel(function (t) {
										return t.resizeNearestNeighborBackprop(
											e,
											n[0],
											r
										);
	...
	var zc = Fe({
			matMul_: function (t, e, s, u, c, l) {
				...
				null != c &&
					xn(
						y,
						(g = Tt((g = re(c, "bias", "fused matMul")), r)[0])
							.shape
					);
				var b = { $a: x, $b: w };
				return (
	...
	var Vc = (function () {
		...
		return (
			...
			(t.prototype.neg = function (t) {
				return (
					this.assertNotComplex(t, "neg"), this.multiply(Ve(-1), t)
				);
			}),
			(t.prototype.add = function (t, e) {
			...
			(t.prototype.erf = function (t) {
				...
				for (
					...
					e[r] =
						1 -
						((((1.061405429 * i - 1.453152027) * i + 1.421413741) *
							i -
							0.284496736) *
							i +
							0.254829592) *
			...
			(t.prototype.conv2d = function (t, e, n) {
				...
				for (
					...
					for (
						...
						for (
							var g = v + m * c.strides[1],
								y = m * n.strideHeight - s,
								x = 0;
							x < r;
							x++
						) {
			...
			(t.prototype.fftImpl = function (t, e) {
				...
				if (this.isExponentOf2(r)) {
					var o = this.fftRadix2(n, r, e).as2D(
						t.shape[0],
						t.shape[1]
					);
			...
			(t.prototype.depthToSpace = function (t, e, n) {
				...
				for (
					...
					for (var d = 0; d < s; ++d)
						for (
							var v = Math.floor(d / e), m = d % e, g = 0;
							g < u;
							++g
						)
							for (
								var y = Math.floor(g / e),
									x = (m * e + (g % e)) * c,
									w = 0;
								w < c;
								++w
	...
	function Qc(t) {
		...
		return {
			...
			modelTopologyBytes:
				null == t.modelTopology
					? 0
					: Kc(JSON.stringify(t.modelTopology)),
			weightSpecsBytes:
	...
	var Jc = (function () {
			...
			return (
				(i.getInstance = function () {
					return (
						null == i.instance && (i.instance = new i()), i.instance
					);
				}),
		...
		tl = (function () {
			...
			return (
				(r.getInstance = function () {
					return (
						null == r.instance && (r.instance = new r()), r.instance
					);
				}),
					...
					switch (t.label) {
						case 0:
							return (
								...
								D(
									0 < (e = Jc.getLoadHandlers(l)).length,
									function () {
										return (
								...
								(n = e[0]),
								D(
									0 < (r = Jc.getSaveHandlers(h)).length,
									function () {
										return (
						...
						case 1:
							return (
								(u = t.sent()),
								p && s
									? [4, tl.getManager(i).removeModel(a)]
									: [3, 3]
							);
						case 2:
							t.sent(), (t.label = 3);
								...
								(r.onupgradeneeded = function () {
									...
									(r.onsuccess = function () {
										...
										(o.onsuccess = function () {
											for (
												var t = {}, e = 0, n = o.result;
												e < n.length;
												e++
											) {
												var r = n[e];
												t[r.modelPath] =
													r.modelArtifactsInfo;
											}
											i(t);
										}),
					...
					return m(this, void 0, void 0, function () {
						...
						return R(this, function (t) {
							if (
								null ==
								(e = JSON.parse(
									this.LS.getItem(this.keys.info)
								))
							)
								throw new Error(
							...
							if (
								...
								null ==
									(r = JSON.parse(
										this.LS.getItem(this.keys.topology)
									)))
							)
								throw new Error(
							...
							if (
								...
								null ==
									(s = this.LS.getItem(this.keys.weightData)))
							)
								throw new Error(
			...
			if (
				((this.fetchFunc = function (e, t) {
					return n.fetchFunc(e, t).catch(function (t) {
						throw new Error(
							"Request for " + e + " failed due to error: " + t
						);
					});
				}),
				...
				return R(this, function (t) {
					switch (t.label) {
						case 0:
							return (
								(e = el(n)),
								[4, tl.getManager(e.scheme).removeModel(e.path)]
							);
						case 1:
							return [2, t.sent()];
					}
	...
	var Ll = Fe({
		...
		zl = (function () {
			...
			return (
				(e.getMap = function () {
					return (
						null == e.instance && (e.instance = new e()), e.instance
					);
				}),
					...
					e = function (o) {
						...
						null == n.accumulatedGrads[o] &&
							...
							null == n.accumulatedUpdates[o] &&
								ue(function () {
									c.accumulatedUpdates[o] = nn(i).variable(
										!1
									);
								});
						var a = t[o],
						...
						ue(function () {
							var t = c.rhoScalar
									.mul(s)
									.add(c.oneMinusRho.mul(a.square())),
								e = u
									.add(c.epsilonScalar)
									.sqrt()
								...
								n = c.rhoScalar
									.mul(u)
									.add(c.oneMinusRho.mul(e.square()));
			...
			(t.prototype.dispose = function () {
				...
				this.c.dispose(),
					...
					null != this.accumulatedUpdates &&
						(Object.keys(this.accumulatedUpdates).forEach(function (
							t
						) {
							return e.accumulatedUpdates[t].dispose();
						}),
						Object.keys(this.accumulatedGrads).forEach(function (
							t
						) {
				...
				var a = this,
					e = function (n) {
						...
						ue(function () {
							...
							var e = a.c
								.mul(o.div(t.add(a.epsilon).sqrt()))
								.add(r);
							r.assign(e);
						});
					},
				...
				ue(function () {
					...
					for (var n in f) {
						...
						null == d.accumulatedSecondMoment[n] &&
							((o = !1),
							(d.accumulatedSecondMoment[n] = nn(r).variable(o)));
						var i = f[n],
							a = d.accumulatedFirstMoment[n],
							s = d.accumulatedSecondMoment[n],
							u = d.beta1Scalar
								.mul(a)
								.add(d.oneMinusBeta1.mul(i)),
							c = d.beta2Scalar
								.mul(s)
								.add(d.oneMinusBeta2.mul(i.square())),
							l = u.div(t),
							h = c.div(e);
						d.accumulatedFirstMoment[n].assign(u),
							d.accumulatedSecondMoment[n].assign(c);
						var p = d.c
							.mul(l.div(d.epsScalar.add(h.sqrt())))
							.add(r);
						r.assign(p);
					}
			...
			(t.prototype.dispose = function () {
				...
				this.c.dispose(),
					...
					null != this.accumulatedFirstMoment &&
						Object.keys(this.accumulatedFirstMoment).forEach(
							function (t) {
								return e.accumulatedFirstMoment[t].dispose();
							}
						),
					null != this.accumulatedSecondMoment &&
						Object.keys(this.accumulatedSecondMoment).forEach(
							function (t) {
				...
				ue(function () {
					...
					for (var n in f) {
						...
						null == d.accumulatedWeightedInfNorm[n] &&
							((o = !1),
							(d.accumulatedWeightedInfNorm[n] =
								nn(r).variable(o)));
						var i = f[n],
							a = d.accumulatedFirstMoment[n],
			...
			(t.prototype.dispose = function () {
				...
				this.c.dispose(),
					...
					null != this.accumulatedWeightedInfNorm &&
						Object.keys(this.accumulatedWeightedInfNorm).forEach(
							function (t) {
								return e.accumulatedWeightedInfNorm[
									t
								].dispose();
							}
						);
				...
				var h = this,
					e = function (i) {
						...
						null == n.accumulatedMeanSquares[i] &&
							ue(function () {
								h.accumulatedMeanSquares[i] = nn(a).variable(
									!1
								);
							}),
							null == n.accumulatedMeanGrads[i] &&
								n.centered &&
								ue(function () {
									h.accumulatedMeanGrads[i] = nn(a).variable(
										!1
									);
								}),
							null == n.accumulatedMoments[i] &&
								ue(function () {
									h.accumulatedMoments[i] = nn(a).variable(
										!1
									);
								});
							...
							if (h.centered) {
								...
								(n = h.momentumScalar
									...
									.add(
										h.c
											.mul(l)
											.div(o.add(h.epsilonScalar).sqrt())
									)),
			...
			(t.prototype.dispose = function () {
				...
				this.c.dispose(),
					...
					null != this.accumulatedMeanSquares &&
						Object.keys(this.accumulatedMeanSquares).forEach(
							function (t) {
					...
					null != this.accumulatedMeanGrads &&
						this.centered &&
						Object.keys(this.accumulatedMeanGrads).forEach(
							function (t) {
								return e.accumulatedMeanGrads[t].dispose();
							}
						),
					null != this.accumulatedMoments &&
						Object.keys(this.accumulatedMoments).forEach(function (
							t
						) {
	...
	var _h,
		Sh = (function () {
			...
			return (
				...
				(l.prototype.round = function () {
					var t = [this.x, this.y, this.width, this.height].map(
						function (t) {
							return Math.round(t);
						}
					);
		...
		Rh = (function (i) {
			function t(t, e, n, r, o) {
				return (
					void 0 === o && (o = !1),
					i.call(this, { left: t, top: e, right: n, bottom: r }, o) ||
						this
				);
			}
			return a(t, i), t;
		...
		kh = (function () {
			...
			return (
				...
				Object.defineProperty(n.prototype, "relativeBox", {
					get: function () {
						return new Sh(this._box).rescale(
							this.imageDims.reverse()
						);
					},
					enumerable: !0,
					configurable: !0,
	...
	function rp(t, e) {
		...
		var r = t.startsWith("http://")
			...
			a =
				r +
				(t.endsWith(".json") ? o.slice(0, o.length - 1) : o).join("/");
		return {
	...
	var Mp = (function () {
			function t(t) {
				...
				if (
					...
					"number" != typeof this._inputSize ||
						this._inputSize % 32 != 0)
				)
					throw new Error(
						this._name +
		...
		Op = (function (n) {
			...
			return (
				...
				Object.defineProperty(r.prototype, "withClassScores", {
					get: function () {
						return (
							this.config.withClassScores ||
							1 < this.config.classes.length
						);
					},
					enumerable: !0,
					configurable: !0,
				...
				(r.prototype.forwardInput = function (e, n) {
					...
					return ue(function () {
						...
						return (
							(t = (t = r.config.meanRgb
								? Ep(t, r.config.meanRgb)
								: t).div(Ve(256))),
				...
				(r.prototype.extractParamsFromWeigthMap = function (t) {
					return (function (t, e) {
						...
						if (e.withSeparableConvs) {
							var u =
								(e.filterSizes && e.filterSizes.length) || 9;
							n = {
	...
	var Xp = (function (r) {
			...
			return (
				...
				(t.prototype.runNet = function (e) {
					...
					if (!r)
						throw new Error(
							this._name + " - load model before inference"
						);
					return ue(function () {
						var t =
							e instanceof gp
								? n.faceFeatureExtractor.forwardInput(e)
								: e;
				...
				Object.defineProperty(t.prototype, "relativePositions", {
					get: function () {
						...
						return this._positions.map(function (t) {
							return t
								.sub(e._shift)
								.div(new lh(e.imageWidth, e.imageHeight));
						});
					},
					enumerable: !0,
					configurable: !0,
	...
	var uf = Object.freeze({
		...
		drawFaceExpressions: function (o, t, i, a) {
			void 0 === i && (i = 0.1),
				(Array.isArray(t) ? t : [t]).forEach(function (t) {
					var e =
						t instanceof Qp ? t : Zp(t) ? t.expressions : void 0;
					if (!e)
						throw new Error(
					...
					var n = e.asSortedArray().filter(function (t) {
						...
						r = Bp(t)
							? t.detection.box.bottomLeft
							: a || new lh(0, 0);
					new Hh(
						n.map(function (t) {
							return (
								t.expression + " (" + gh(t.probability) + ")"
							);
						}),
						r
					).draw(o);
			...
			return (
				...
				(t.prototype.runNet = function (n) {
					...
					return ue(function () {
						var t =
								n instanceof gp
									? r.faceFeatureExtractor.forwardInput(n)
									: n,
							e = Gs(t, [7, 7], [2, 2], "valid").as2D(
								t.shape[0],
								-1
							);
						return {
			...
			(e.prototype.extractParamsFromWeigthMap = function (t) {
				return (function (t) {
					var e = [],
						...
						w = t.fc;
					if (
						(e.push({ originalPath: "fc", paramPath: "fc" }),
						!ph(w))
					)
						throw new Error(
			...
			(e.prototype.extractParams = function (t) {
				return (function (t) {
					...
					if ((o.push({ paramPath: "fc" }), 0 !== r().length))
						throw new Error(
							"weights remaing after extract: " + r().length
						);
					return {
						params: {
							conv32_down: u,
				...
				(e.prototype.forwardInput = function (u) {
					...
					return ue(function () {
						var l,
							...
							e = zf(
								Bu(Du(t, Ve(0.007843137718737125)), Ve(1)),
								c.mobilenetv1
							),
							n =
								((l = e.out),
	...
	var rd = (function (o) {
		function t(t, e, n, r) {
			return (
				o.call(this, { left: t, top: e, right: n, bottom: r }, !0) ||
				this
			);
		}
		return a(t, o), t;
					...
					case 1:
						return (
							...
							e.forEach(function (t) {
								...
								for (
									var n = e.getImageData(0, 0, a, s).data,
										r = [],
										o = 0;
									o < n.length;
									o += 4
						...
						p(this, void 0, void 0, function () {
							...
							return P(this, function (t) {
								switch (t.label) {
									case 0:
										return (
											(e = this.forwardInput), [4, yp(n)]
										);
									case 1:
										return [
											4,
											e.apply(this, [t.sent(), r]),
										];
									case 2:
	...
	var kd = (function (o) {
			function t(t, e, n) {
				var r = o.call(this) || this;
				return (
					(r.parentTask = t), (r.input = e), (r.extractedFaces = n), r
				);
			}
			return a(t, o), t;
		})(Xf),
								...
								case 5:
									return (
										...
										[
											...
											Promise.all(
												r.map(function (t) {
													return a.landmarkNet.detectLandmarks(
														t
													);
												})
											),
							...
							switch (t.label) {
								...
								case 5:
									return (
										...
										[
											4,
											this.landmarkNet.detectLandmarks(
												r[0]
											),
										]
									);
								...
								case 2:
									if (
										!(o =
											r instanceof Kf
												? function (t) {
														return xd.tinyFaceDetector.locateFaces(
															t,
															r
														);
												  }
												: r instanceof Hf
												? function (t) {
														return xd.ssdMobilenetv1.locateFaces(
															t,
															r
														);
												  }
												: r instanceof Mp
												? function (t) {
														return xd.tinyYolov2.locateFaces(
															t,
															r
														);
												  }
